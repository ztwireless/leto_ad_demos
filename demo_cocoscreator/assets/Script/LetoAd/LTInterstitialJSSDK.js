(function() {
    const LTiOSInterstitialJS = require("./iOS/LTiOSInterstitialJS");
    const LTAndroidInterstitialJS = require("./Android/LTAndroidInterstitialJS");
    ...
    let LTInterstitialSDK = LTInterstitialSDK || {
