(function() {
    const LTAndroidFeedJS = require("./Android/LTAndroidFeedJS");
    const LTiOSFeedJS = require("./iOS/LTiOSFeedJS");
    ...
    let LTFeedSDK = LTFeedSDK || {
        ...
        loadFeed : function(adId, params) {
            if (undefined != platformBridge && platformBridge != null) {
                platformBridge.loadFeed(adId, params || "{}");
            } else {
